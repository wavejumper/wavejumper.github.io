...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__45165_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__45165_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__45165_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__45166){
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__45170,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45171__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45171__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45171__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__45175 = (function (){var or__4131__auto__ = color;
...
var fexpr__45174 = (function (){var G__45176 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__45176) : style_map.call(null,G__45176));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__45177){
var vec__45178 = p__45177;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45178,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45178,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45178,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__45181){
var vec__45182 = p__45181;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45182,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45182,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45182,(2),null);
...
var G__45292 = cljs.core.next(ssv);
var G__45293 = (this_ssv == null);
var G__45294 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__45295 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__45292;
doing_nil_QMARK_ = G__45293;
last_elide = G__45294;
out = G__45295;
continue;
}
...
var vec__45207 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45207,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45207,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45207,(2),null);
...
var G__45296 = cljs.core.next(remaining_cvec);
var G__45297 = new_idx;
var G__45298 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__45296;
idx = G__45297;
out = G__45298;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__45218,cursor_vec){
var vec__45219 = p__45218;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45219,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45219,(1),null);
var focus_vec = vec__45219;
...
var vec__45225 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45225,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45225,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__45229){
var vec__45230 = p__45229;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45230,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45230,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__45237,existing_count){
var vec__45238 = p__45237;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45238,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45238,(1),null);
...
return cljs.core.filterv(((function (s__$1,len,cursor__$1,vec__45238,s,cursor){
return (function (p1__45234_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__45234_SHARP_))));
});})(s__$1,len,cursor__$1,vec__45238,s,cursor))
...
var vec__45246 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45246,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45246,(1),null);
var cvec_element = vec__45246;
if((cvec_element == null)){
var G__45355 = cljs.core.next(cvec_nl);
var G__45356 = (idx + (1));
var G__45357 = start;
var G__45358 = out;
cvec_nl = G__45355;
...
var G__45359 = cljs.core.next(cvec_nl);
var G__45360 = (idx + (1));
var G__45361 = idx;
var G__45362 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__45359;
idx = G__45360;
start = G__45361;
out = G__45362;
...
var G__45363 = cljs.core.next(cvec_nl);
var G__45364 = (idx + (1));
var G__45365 = (idx + (1));
var G__45366 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__45363;
idx = G__45364;
start = G__45365;
out = G__45366;
...
var G__45367 = cljs.core.next(cvec_nl);
var G__45368 = (idx + (1));
var G__45369 = idx;
var G__45370 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__45367;
idx = G__45368;
start = G__45369;
out = G__45370;
...
var G__45371 = cljs.core.next(cvec_nl);
var G__45372 = (idx + (1));
var G__45373 = start;
var G__45374 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__45371;
idx = G__45372;
start = G__45373;
out = G__45374;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__45250_SHARP_,p2__45249_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__45249_SHARP_)){
return cljs.core.reduced(p1__45250_SHARP_);
} else {
return (p1__45250_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__45258,p__45259){
var vec__45263 = p__45258;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45263,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45263,(1),null);
var vec__45266 = p__45259;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45266,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45266,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__45277,cvec,focus_vec){
...
var map__45279 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45278__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45279__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45279__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45279__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__45278,map__45278__$1,options,map__45279,map__45279__$1,focus,lines,paths){
return (function (p1__45275_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__45275_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__45278,map__45278__$1,options,map__45279,map__45279__$1,focus,lines,paths))
,path_vecs);
