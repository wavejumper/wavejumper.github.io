...
var G__45888 = clojure.zip.node(loc);
var fexpr__45887 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var G__45890 = clojure.zip.node(loc);
var fexpr__45889 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__45889.cljs$core$IFn$_invoke$arity$1 ? fexpr__45889.cljs$core$IFn$_invoke$arity$1(G__45890) : fexpr__45889.call(null,G__45890));
} else {
...
var fexpr__45891 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__45891.cljs$core$IFn$_invoke$arity$2 ? fexpr__45891.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__45891.call(null,node,children));
});
/**
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45892,(1),null);
var vec__45895 = clojure.zip.children(loc);
var seq__45896 = cljs.core.seq(vec__45895);
var first__45897 = cljs.core.first(seq__45896);
var seq__45896__$1 = cljs.core.next(seq__45896);
var c = first__45897;
var cnext = seq__45896__$1;
var cs = vec__45895;
...
var vec__45898 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45898,(0),null);
...
var path = map__45901__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45901__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45901__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45901__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45901__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45901__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__45905 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45905,(0),null);
var map__45908 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45905,(1),null);
...
var path = map__45908__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45908__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__45909 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45908__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__45913 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45913,(0),null);
var map__45916 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45913,(1),null);
...
var path = map__45916__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45916__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45916__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4120__auto__ = path;
if(cljs.core.truth_(and__4120__auto__)){
return r;
} else {
...
var map__45921 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45918,(1),null);
...
var path = map__45921__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45921__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45921__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4120__auto__ = path;
if(cljs.core.truth_(and__4120__auto__)){
...
var vec__45923 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45923,(0),null);
...
var path = map__45926__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45926__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45926__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4120__auto__ = path;
if(cljs.core.truth_(and__4120__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__45928 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45928,(0),null);
var map__45931 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45928,(1),null);
...
var path = map__45931__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45931__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__45933 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45933,(0),null);
var map__45936 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45933,(1),null);
...
var path = map__45936__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45936__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__45938 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45938,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45938,(1),null);
...
/** @this {Function} */
clojure.zip.edit.cljs$lang$applyTo = (function (seq45941){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45942,G__45943,seq45941__$2);
});
...
var G__45987 = clojure.zip.rightmost(child);
loc__$1 = G__45987;
continue;
} else {
return loc__$1;
...
var vec__45944 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45944,(0),null);
...
var path = map__45947__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45947__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45947__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45947__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45947__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__45990 = clojure.zip.rightmost(child);
loc__$1 = G__45990;
continue;
} else {
return loc__$1;
