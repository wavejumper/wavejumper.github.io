...
var G__42104 = devtools.prefs.pref(v);
v = G__42104;
continue;
} else {
return v;
...
}catch (e42080){var _e__39630__auto__ = e42080;
return false;
}})();
...
}catch (e42084){var _e__39630__auto__ = e42084;
return false;
}})();
...
}catch (e42086){var _e__39630__auto__ = e42086;
return false;
}}
}
});
...
var vec__42094 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42094,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42094,(1),null);
...
return cljs.core.some((function (p1__42099_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42099_SHARP_);
}),template);
});
