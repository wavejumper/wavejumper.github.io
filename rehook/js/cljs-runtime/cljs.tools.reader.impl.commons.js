...
var G__44738 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__44738;
continue;
} else {
return ch;
...
var vec__44733 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44733,(0),null);
return (match === s);
});
...
var G__44741 = (i__4731__auto___44740 + (1));
i__4731__auto___44740 = G__44741;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq44736){
...
return (function() { 
var G__44742__delegate = function (rdr,_){
...
var G__44742 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__44743__i = 0, G__44743__a = new Array(arguments.length -  1);
while (G__44743__i < G__44743__a.length) {G__44743__a[G__44743__i] = arguments[G__44743__i + 1]; ++G__44743__i;}
  _ = new cljs.core.IndexedSeq(G__44743__a,0,null);
} 
return G__44742__delegate.call(this,rdr,_);};
G__44742.cljs$lang$maxFixedArity = 1;
G__44742.cljs$lang$applyTo = (function (arglist__44744){
var rdr = cljs.core.first(arglist__44744);
var _ = cljs.core.rest(arglist__44744);
return G__44742__delegate(rdr,_);
});
