...
var G__46295 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__46295;
continue;
} else {
var G__46296 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__46296;
continue;
}
} else {
var G__46297 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__46297;
continue;
}
}
...
var G__46289 = zloc;
var G__46290 = (function (){var G__46291 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__46292 = zloc;
var G__46292__$1 = (((G__46292 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__46292) : rewrite_clj.zip.node.call(null,G__46292)));
if((G__46292__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__46292__$1) : zprint.zutil.edn_STAR_.call(null,G__46292__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__46291) : rewrite_clj.zip.root.call(null,G__46291));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__46289,G__46290) : rewrite_clj.zip.replace.call(null,G__46289,G__46290));
});
/**
...
var G__46298 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__46298;
continue;
}
break;
...
var G__46299 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__46300 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__46299;
out = G__46300;
continue;
} else {
...
var G__46301 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__46302 = cljs.core.next(new_loc);
var G__46303 = replaced_loc;
nloc = G__46301;
new_loc = G__46302;
last_loc = G__46303;
continue;
...
return zprint.rewrite.sort_val((function (){var G__46293 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__46293) : rewrite_clj.zip.down.call(null,G__46293));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__46294_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__46294_SHARP_) : rewrite_clj.zip.tag.call(null,p1__46294_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__46294_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__46294_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
