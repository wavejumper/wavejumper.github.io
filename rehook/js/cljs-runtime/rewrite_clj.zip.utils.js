...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__45991,k,f){
var vec__45992 = p__45991;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45992,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45992,(1),null);
var loc = vec__45992;
...
var G__46038 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__46038;
continue;
}
break;
...
var G__46039 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__46039;
continue;
} else {
return zloc__$1;
...
var G__46040 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__46040;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__46013){
var vec__46014 = p__46013;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46014,(0),null);
var map__46017 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46014,(1),null);
...
var path = map__46017__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46017__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__46014;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__46020){
...
var path = map__46024__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46024__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__46021;
if(cljs.core.seq(r)){
...
var vec__46033 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46033,(0),null);
var map__46036 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46033,(1),null);
...
var path = map__46036__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46036__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46036__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46036__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46036__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
