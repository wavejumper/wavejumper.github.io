...
boonmee provides a similar JSON protocol as tsserver. Like tsserver, boonmee is low-level. It is up to developers of editor plugins/IDEs to integrate with boonmee if they so desire.
