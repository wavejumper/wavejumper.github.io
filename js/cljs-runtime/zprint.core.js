...
var vec__47626 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__47630 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47630,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47630,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47626,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47626,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__47640){
var vec__47641 = p__47640;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47641,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47641,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47644,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47644,(1),null);
...
var vec__47648 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47648,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47648,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47648,(2),null);
var vec__47651 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47651,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47651,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47651,(2),null);
...
var G__47654 = special_option;
var G__47654__$1 = (((G__47654 instanceof cljs.core.Keyword))?G__47654.fqn:null);
switch (G__47654__$1) {
case "explain":
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__47655){
var vec__47656 = p__47655;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47656,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47656,(1),null);
...
var vec__47662 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47662,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47662,(1),null);
...
var G__47665 = zprint.core.parse_string_all_options(rest_options);
var G__47666 = zprint.core.zprint_str_internal;
var G__47667 = ":parse-string-all? call";
var G__47668 = (function (){var G__47669 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__47669) : zprint.zutil.edn_STAR_.call(null,G__47669));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__47665,G__47666,G__47667,G__47668) : zprint.core.process_multiple_forms.call(null,G__47665,G__47666,G__47667,G__47668));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__47670 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47670,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47670,(1),null);
...
/** @this {Function} */
zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq47659){
var G__47660 = cljs.core.first(seq47659);
var seq47659__$1 = cljs.core.next(seq47659);
var G__47661 = cljs.core.first(seq47659__$1);
var seq47659__$2 = cljs.core.next(seq47659__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47660,G__47661,seq47659__$2);
});
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq47691){
var G__47695 = cljs.core.first(seq47691);
var seq47691__$1 = cljs.core.next(seq47691);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47695,seq47691__$1);
});
...
var G__47810 = (i__4731__auto___47807 + (1));
i__4731__auto___47807 = G__47810;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq47697){
var G__47698 = cljs.core.first(seq47697);
var seq47697__$1 = cljs.core.next(seq47697);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47698,seq47697__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___47813 = arguments.length;
var i__4731__auto___47814 = (0);
while(true){
if((i__4731__auto___47814 < len__4730__auto___47813)){
args__4736__auto__.push((arguments[i__4731__auto___47814]));

var G__47815 = (i__4731__auto___47814 + (1));
i__4731__auto___47814 = G__47815;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq47699){
var G__47700 = cljs.core.first(seq47699);
var seq47699__$1 = cljs.core.next(seq47699);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47700,seq47699__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___47816 = arguments.length;
var i__4731__auto___47817 = (0);
while(true){
if((i__4731__auto___47817 < len__4730__auto___47816)){
args__4736__auto__.push((arguments[i__4731__auto___47817]));

var G__47818 = (i__4731__auto___47817 + (1));
i__4731__auto___47817 = G__47818;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq47705){
var G__47706 = cljs.core.first(seq47705);
var seq47705__$1 = cljs.core.next(seq47705);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47706,seq47705__$1);
});
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__47717,form){
var vec__47718 = p__47717;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47718,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47718,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47718,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47718,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__47723 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47723,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47723,(1),null);
...
var forms = (function (){var G__47734 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__47734) : zprint.zutil.edn_STAR_.call(null,G__47734));
})();
