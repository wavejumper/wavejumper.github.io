...
if((c === "\n")){
var G__45834 = escape_QMARK_;
var G__45835 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__45834;
lines = G__45835;
continue;
} else {
buf.append(c);

var G__45836 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__45837 = lines;
escape_QMARK_ = G__45836;
lines = G__45837;
continue;
...
var G__45831 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__45831) : rewrite_clj.node.string_node.call(null,G__45831));
});
...
var G__45832 = cljs.core.re_pattern(regex);
var G__45833 = ["#\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(regex),"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__45832,G__45833) : rewrite_clj.node.token_node.call(null,G__45832,G__45833));
});
