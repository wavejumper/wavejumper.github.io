...
var G__39691 = cljs.core.PersistentArrayMap.EMPTY;
var G__39692 = native_stack_trace;
var G__39693 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__39694 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__39691,G__39692,G__39693,G__39694) : cljs.stacktrace.parse_stacktrace.call(null,G__39691,G__39692,G__39693,G__39694));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39696__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39696__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39696__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e39695){var _e = e39695;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___39728 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___39728)){
var seen_errors_39729 = temp__5733__auto___39728;
if(cljs.core.truth_(seen_errors_39729.has(self))){
} else {
seen_errors_39729.add(self);

var temp__5735__auto___39730 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___39730)){
var sense_39731 = temp__5735__auto___39730;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_39731)].join('');
} else {
}
}
} else {
