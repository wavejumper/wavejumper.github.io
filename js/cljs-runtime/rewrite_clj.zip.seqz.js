...
var G__46086 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__46086__$1 = (((G__46086 == null))?null:cljs.core.iterate(((function (G__46086,n0,temp__5733__auto__){
return (function (loc){
...
});})(G__46086,n0,temp__5733__auto__))
,G__46086));
var G__46086__$2 = (((G__46086__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__46086__$1));
var G__46086__$3 = (((G__46086__$2 == null))?null:cljs.core.last(G__46086__$2));
if((G__46086__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__46086__$3);
}
} else {
return zloc;
}
...
var G__46091 = rewrite_clj.zip.move.right(v);
var G__46092 = rewrite_clj.zip.move.up(v);
loc = G__46091;
parent = G__46092;
continue;
} else {
var G__46093 = rewrite_clj.zip.move.right(v0);
var G__46094 = parent;
loc = G__46093;
parent = G__46094;
continue;
...
var G__46095 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__46096 = rewrite_clj.zip.move.up(v);
loc = G__46095;
parent = G__46096;
continue;
} else {
var G__46097 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__46098 = parent;
loc = G__46097;
parent = G__46098;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__46089 = zloc;
var G__46089__$1 = (((G__46089 == null))?null:rewrite_clj.zip.move.down(G__46089));
var G__46089__$2 = (((G__46089__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__46089__$1,k));
if((G__46089__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__46089__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__46090 = rewrite_clj.zip.move.down(zloc);
var G__46090__$1 = (((G__46090 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__46090));
if((G__46090__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__46090__$1);
}
})(),k);
}
});
